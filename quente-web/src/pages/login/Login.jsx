...
import { login } from "@/modules/core/services/auth.service";
import { setLoading } from "@/modules/core/reducers/auth.reducer";
import { useNavigate } from "react-router-dom";
import Logo from "@/assets/images/logo.png";
const { VITE_APP_EMAIL_DEMO = "", VITE_APP_PASSWORD_DEMO = "" } = import.meta.env;
...
const Login = () => {
  ...
  const handleDemoLogin = () => {
    setValue("email", VITE_APP_EMAIL_DEMO);
    setValue("password", VITE_APP_PASSWORD_DEMO);
    handleLogin();
  };
